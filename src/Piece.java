...
public abstract class Piece implements Serializable {
    ...
    public final Image getImage() {
        String imageName = name + "-" + side;
        String imagePath = "pieces/resources/" + imageName + ".png";

        try {
            URL imageURL = Piece.class.getResource(imagePath);
            if (imageURL != null) {
            ...
            System.err.println("Failed to read image: " + imageName + ": " + e);
            return null;
        }
    }
