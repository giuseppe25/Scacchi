...
public class BoardPanel extends JComponent
    ...
    private static final Logger LOG =
        Logger.getLogger("src.gui.BoardPanel");
    ...
    static final int HIGHLIGHT_PADDING = 0;
    ...
    static final Color MOVEMENT = new Color(0, 255, 118, 205);

    /** Last move highlight color. */
    static final Color LAST = new Color(112, 181, 255, 255);

    /** Minimum size of a tile, in pixels. */
    static final int MIN_SIZE = 25;

    /** Preferred size of a tile, in pixels. */
    static final int PREF_SIZE = 65;
    ...
    private void updateSize() {
        setPreferredSize(new Dimension(PREF_SIZE * 8,
                                       PREF_SIZE * 8));
        setMinimumSize(new Dimension(MIN_SIZE * 8,
                                     MIN_SIZE * 8));
    }

    @Override
    public final Dimension getPreferredSize() {
        return new Dimension(PREF_SIZE * 8,
                             PREF_SIZE * 8);
    }
    ...
    public final AffineTransform getTransform() {
        ...
        at.scale(getWidth() / (TILE_SIZE * 8),
                 getHeight() / (TILE_SIZE * 8));
        return at;
    }
